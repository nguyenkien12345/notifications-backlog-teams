...
class SyncService:
    ...
    async def sync_now(self) -> int:
        ...
        try:
            ...
            if not to_process:
                logger.info("New notifications exist but none matched the unread/processing criteria.")
            ...
            logger.info(f"Synchronization complete. Successfully forwarded {synced_count} notifications.")
            return synced_count
